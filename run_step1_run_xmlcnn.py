...
train_dir = os.getcwd() + f'/save/{method_name}/{dataset_name}/train/{seed}'
test_dir = os.getcwd() + f'/save/{method_name}/{dataset_name}/test/{seed}'
log_dir = os.getcwd() + f'/save/{method_name}/{dataset_name}/log/{seed}'
